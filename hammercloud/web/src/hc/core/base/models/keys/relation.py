...
FK_LIST = [
           ...
           ('Site', 'MessageBusEvent', 'site', {'null':'True'}),
...
UNIQUE_TOGETHER_DIC = {
                        ...
                        'TemplateSiteAlarmBase' : ('site','template','alarm'),
