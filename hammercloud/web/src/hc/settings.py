...
# The login URL. Supposes that HammerCloud is installed under the /hc URL.
...
MEDIA_ROOT = os.path.join(HC_DIR, 'uploads')
...
STATIC_ROOT = os.path.join(HC_DIR, 'static')
...
STATICFILES_DIRS = (
    ...
    # TODO(rmedrano): switch to fully static naming (this is legacy from 1.2).
    os.path.join(HC_DIR, 'media'),
)
...
# Import settings from the local_settings.py module
try:
    ...
    import logging
    logging.warning('hc.local_settings could not be imported.')
