...
Job (
 ...
 application = Athena (
    ...
    atlas_environment = ['ATLAS_POOLCOND_PATH=/opt/vo/atlas/local/conditions', 'FRONTIER_SERVER=(serverurl=http://atlassq1-fzk.gridka.de:8021/fzk)(proxyurl=http://t2-atlas-db0.desy.de:3128)', 'FRONTIER_LOG_LEVEL=debug'] ,
    atlas_production = '' ,
