...
/**
   ...
   Note:
   - 19/11/2010 (Nicolas Kerschen):  
     modification of Reta and weta2 cut values in line with release 16 update (as in tags from egammaPIDTools-00-01-29 on)
     (reverting back to old Reta cuts for crack region, correcting small inconsistency in weta2).
...
float getREtaCut(float eT, float eta){
  ...
  const float cutReta37[11][10] = {{ 0.700, 0.700, 0.798, 0.700, 0.700, 0.690, 0.848, 0.876, 0.870, 0.894}  // < 5
				   ...
				   ,{0.900, 0.900, 0.900, 0.900, 0.900, 0.750, 0.900, 0.900, 0.900, 0.900}// 20-30
				   ,{0.900, 0.900, 0.900, 0.900, 0.900, 0.760, 0.900, 0.900, 0.900, 0.900}// 30-40
				   ,{0.900, 0.900, 0.900, 0.900, 0.900, 0.790, 0.900, 0.900, 0.900, 0.900}// 40-50
				   ,{0.900, 0.900, 0.900, 0.900, 0.900, 0.790, 0.900, 0.900, 0.900, 0.900}// 50-60
				   ,{0.900, 0.900, 0.900, 0.900, 0.900, 0.790, 0.900, 0.900, 0.900, 0.900}// 60-70
				   ,{0.900, 0.900, 0.900, 0.900, 0.900, 0.790, 0.900, 0.900, 0.900, 0.900}// 70-80
				   ,{0.900, 0.900, 0.900, 0.900, 0.900, 0.790, 0.900, 0.900, 0.900, 0.900}};// 80<
...
float getW2Cut(float eT, float eta){
  ...
  const float cutWeta2[11][10] = {{ 0.014, 0.014, 0.014, 0.014, 0.014, 0.028, 0.017, 0.014, 0.014, 0.014}   // < 5 
				  ...
				  ,{0.012, 0.012, 0.012, 0.013, 0.013, 0.025, 0.015, 0.013, 0.013, 0.013} // 20-30
				  ,{0.012, 0.012, 0.012, 0.013, 0.013, 0.025, 0.015, 0.013, 0.013, 0.013} // 30-40
				  ,{0.012, 0.012, 0.012, 0.013, 0.013, 0.025, 0.015, 0.013, 0.013, 0.013} // 40-50
				  ,{0.012, 0.012, 0.012, 0.013, 0.013, 0.025, 0.015, 0.013, 0.013, 0.013} // 50-60
				  ,{0.012, 0.012, 0.012, 0.013, 0.013, 0.025, 0.015, 0.013, 0.013, 0.013} // 60-70
				  ,{0.012, 0.012, 0.012, 0.013, 0.013, 0.025, 0.015, 0.013, 0.013, 0.013} // 70-80
				  ,{0.012, 0.012, 0.012, 0.013, 0.013, 0.025, 0.015, 0.013, 0.013, 0.013}};// 80<;
