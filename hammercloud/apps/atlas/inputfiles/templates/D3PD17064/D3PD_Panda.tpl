Job (
 ...
 application = Athena (
    ...
    trf_parameter = {} ,
    recex_type = '' ,
    atlas_run_config = {'input': {}, 'other': {}, 'output': {'alloutputs': ['physics.root', 'histo.root', 'physics.root'], 'outTHIST': ['GLOBAL', 'StreamNTUP_PHYSICSTrigDec'], 'outAANT': [('StreamNTUP_PHYSICSAANTStream', 'StreamNTUP_PHYSICS', 'physics.root')]}} ,
    atlas_environment = [] ,
    atlas_production = '17.0.6.4' ,
