...
Job (
 ...
 application = Athena (
    ...
    trf_parameter = {} ,
    recex_type = '' ,
    atlas_run_config = {'input': {}, 'other': {}, 'output': {'alloutputs': ['physics.root', 'monitoring.root'], 'outTHIST': ['GLOBAL'], 'outAANT': [('D3PD', 'D3PD')]}} ,
    atlas_environment = [] ,
    atlas_production = '15.6.10.6' ,
    atlas_release = '15.6.10' ,
