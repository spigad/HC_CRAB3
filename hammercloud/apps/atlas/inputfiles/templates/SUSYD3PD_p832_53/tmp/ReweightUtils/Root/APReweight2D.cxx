...
APReweight2D::APReweight2D(TH2* denominator_in, TH2* numerator_in, bool isTrig) { /*!< Constructor which takes the object to be reweighted, the object container to perform the reweighting on and the corresponding efficiency map. The reweighting will be performed in all dimensions contained in the EfficiencyMap. */
