...
APEvtWeight weight1(APEvtWeight::kMuon);
APEvtWeight weight2(APEvtWeight::kElectron);
...
int ErrorPropagation() {
  ...
  for (unsigned int i = 0, I = event_values_xA.size(); i < I; i+=2) {
    APEvtWeight *weight_A = new APEvtWeight(APEvtWeight::kMuon);
    APEvtWeight *weight_B = new APEvtWeight(APEvtWeight::kElectron);
