...
public:
  ...
  THnSparse* GetUncertHistogram( APEvtWeight::ObjType type );                    /*!< Returns THnSparse holding the uncertainties for given object type. */
...
protected:
  ...
  THnSparse* _linear_uncert_mu;                                                  /*!< Holds the filled uncertainties of all muons for final uncertainty propagation. */
  THnSparse* _linear_uncert_el;                                                  /*!< Holds the filled uncertainties of all electrons for final uncertainty propagation. */
  THnSparse* _linear_uncert_jet;                                                 /*!< Holds the filled uncertainties of all jets for final uncertainty propagation. */
  THnSparse* _linear_uncert_mumo;                                                /*!< Holds the filled uncertainties of all muons for final uncertainty propagation for ored multiobject triggers. */
  THnSparse* _linear_uncert_elmo;                                                /*!< Holds the filled uncertainties of all electrons for final uncertainty propagation for ored multiobject triggers. */
  THnSparse* _linear_uncert_jetmo;                                               /*!< Holds the filled uncertainties of all jets for final uncertainty propagation for ored multiobject triggers. */
  THnSparse* _linear_uncert_dimu;                                                /*!< Holds the filled uncertainties of all di-muons for final uncertainty propagation. */
  THnSparse* _linear_uncert_diel;                                                /*!< Holds the filled uncertainties of all di-electrons for final uncertainty propagation. */
  THnSparse* _linear_uncert_dijet;                                               /*!< Holds the filled uncertainties of all di-jets for final uncertainty propagation. */
