             ...
             P4ImplEEtaPhiM >
{
 ...
 public:
  ...
  void set4Mom (const HepLorentzVector & theHlv );  
  ...
  void setUncombined4Mom (const HepLorentzVector & theHlv );  
  ...
  void setErrorMatrix(HepSymMatrix);
  void setUncombinedErrorMatrix(HepSymMatrix);
...
inline
void 
egamma::set4Mom (const HepLorentzVector & hlv )
