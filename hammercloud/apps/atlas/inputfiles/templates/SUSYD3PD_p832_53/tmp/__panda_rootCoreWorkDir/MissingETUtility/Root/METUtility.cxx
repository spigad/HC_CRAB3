...
void METUtility::setObjectMomentaHelper(vector<PhysicsObject> &object, vector<float> pT, vector<float> eta, vector<float> phi, vector<float> E, string caseFlag) {
...
void METUtility::setObjectEnergyUncertaintiesHelper(vector<PhysicsObject> &object, vector<float> energyUp, vector<float> energyDown, string caseFlag) {
...
void METUtility::setObjectResolutionShiftHelper(vector<PhysicsObject> &object, vector<float> resUp, vector<float> resDown, string caseFlag) {
  if(object.size() == 0 && m_verbose) cout << "Set object four-momentum and weights first!" << endl;
...
void METUtility::setObjectResolutionsHelper(vector<PhysicsObject> &objects, vector<float> resolutions, string caseFlag) {
  caseFlag = "whoopty";
...
vector<PhysicsObject> METUtility::GetObjects(std::string objectName) {
...
vector<PhysicsObject> METUtility::getPhysicsObject(std::string type) {
