#ifndef SUSYTools_PhotonIDTool_h
#define SUSYTools_PhotonIDTool_h
...
class PhotonIDTool 
{
 ...
 private:
  ...
  SUSY::PtEtaCollection<double> m_rhad_cut;
  SUSY::PtEtaCollection<double> m_ratio1_cut;
  SUSY::PtEtaCollection<double> m_ratio2_cut;
  SUSY::PtEtaCollection<double> m_weta2_cut;
  SUSY::PtEtaCollection<double> m_f1_cut_min;
  SUSY::PtEtaCollection<double> m_f1_cut_max;
  SUSY::PtEtaCollection<double> m_emax2r_cut;
  SUSY::PtEtaCollection<double> m_deltae_cut;
  SUSY::PtEtaCollection<double> m_wtot_cut;
  SUSY::PtEtaCollection<double> m_fracm_cut;
  SUSY::PtEtaCollection<double> m_w1_cut;
  SUSY::PtEtaCollection<double> m_eratio_cut;

};

}

#endif // #ifdef SUSYTools_PhotonIDTool_h
