...
APReweight3D::APReweight3D(TH3* denominator_in, TH3* numerator_in, bool isTrig) { /*!< Constructor which takes the object to be reweighted, the object container to perform the reweighting on and the corresponding efficiency map. The reweighting will be performed in all dimensions contained in the EfficiencyMap. */
