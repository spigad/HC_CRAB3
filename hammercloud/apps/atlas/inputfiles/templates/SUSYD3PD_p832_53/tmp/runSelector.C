...
void runSelector() {
 try {
  ...
  TString localSelectorPath = "/data/etp4/flegger/susy/D3PDReader_p638/";  // !!! the path to your compiled _C.so on the etp cluster
...
// fileLists.push_back("run.txt");
fileLists.push_back("run_data.txt");
// fileLists.push_back("run_SU4.txt");
//fileLists.push_back("mSugragrid_620.txt"); 
//fileLists.push_back("phenogrid.txt"); 
//fileLists.push_back("missed.txt"); 
//fileLists.push_back("performancetest.txt"); 
