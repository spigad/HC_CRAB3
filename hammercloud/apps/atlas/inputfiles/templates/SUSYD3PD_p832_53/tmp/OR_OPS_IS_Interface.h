...
class OverlapRemoval
{
  ...
  public:
    ...
    virtual unsigned int ElectronElectron_OR(ObjAccess* ele1, ObjAccess* ele2, unsigned int iteration);  
    ...
    virtual void do_Electron_Electron(unsigned int iteration);
...
class ObjectPreSelection
{
  ...
  int index_ele;
  int index_jet;
  int myEleEventNumber;
  int myMuoEventNumber;
  int myJetEventNumber;
};
