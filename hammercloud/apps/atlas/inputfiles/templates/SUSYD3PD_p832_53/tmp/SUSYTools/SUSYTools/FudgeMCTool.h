#ifndef SUSYTools_FudgeMCTool_h
#define SUSYTools_FudgeMCTool_h
...
#include <cmath>
using std::abs;
#include "SUSYTools/PtEtaCollection.h"
...
class FudgeMCTool 
{
 ...
 private:
  ...
  SUSY::PtEtaCollection<double> m_rhad1_ff;
  SUSY::PtEtaCollection<double> m_rhad_ff;
  SUSY::PtEtaCollection<double> m_e277_ff;
  SUSY::PtEtaCollection<double> m_reta_ff;
  SUSY::PtEtaCollection<double> m_rphi_ff;
  SUSY::PtEtaCollection<double> m_weta2_ff;
  SUSY::PtEtaCollection<double> m_f1_ff;
  SUSY::PtEtaCollection<double> m_deltae_ff;
  SUSY::PtEtaCollection<double> m_wtot_ff;
  SUSY::PtEtaCollection<double> m_fside_ff;
  SUSY::PtEtaCollection<double> m_w1_ff;
  SUSY::PtEtaCollection<double> m_eratio_ff;

  // collections of fudge factors errors
  SUSY::PtEtaCollection<double> m_rhad1_fferr;
  SUSY::PtEtaCollection<double> m_rhad_fferr;
  SUSY::PtEtaCollection<double> m_e277_fferr;
  SUSY::PtEtaCollection<double> m_reta_fferr;
  SUSY::PtEtaCollection<double> m_rphi_fferr;
  SUSY::PtEtaCollection<double> m_weta2_fferr;
  SUSY::PtEtaCollection<double> m_f1_fferr;
  SUSY::PtEtaCollection<double> m_deltae_fferr;
  SUSY::PtEtaCollection<double> m_wtot_fferr;
  SUSY::PtEtaCollection<double> m_fside_fferr;
  SUSY::PtEtaCollection<double> m_w1_fferr;
  SUSY::PtEtaCollection<double> m_eratio_fferr;
