...
//   void EMtrack_perigee_CovEclusEclus (double) ; 
  ...
  /** @brief get the position eta error in sampling layer 2; since this
      is used by the EMExtrapolCaloConversion tool, it has to be public */
  double getClusterEtaS1Error(const egamma*, 
			      const EMClusterErrorsParametrizations*) const;
...
private:
  ...
  bool fillPhotonMatrixElements(const egamma*, const EMClusterErrorsParametrizations*, bool forcePhoton=false);
  /** @brief Fill the perigree error details */
