Job (
 ...
 application = Athena (
    ...
    trf_parameter = {} ,
    recex_type = '' ,
    atlas_run_config = {'input': {}, 'other': {}, 'output': {'outAANT': [('StreamNTUP_PHYSICSAANTStream', 'StreamNTUP_PHYSICS')], 'outTHIST': ['GLOBAL', 'StreamNTUP_PHYSICSTrigDec'], 'alloutputs': ['physics.root', 'monitoring.root', 'physics.root']}},
    atlas_environment = [] ,
    atlas_production = '16.6.3.5' ,
    atlas_release = '16.6.3' ,
    options = '' ,
