Job (
 ...
 application = Athena (
    ...
    atlas_run_dir = 'Control/AthenaExamples/AthExRegTutorial/run/' ,
    atlas_exetype = 'ATHENA' ,
    athena_compile = False ,
    trf_parameter = {} ,
    atlas_run_config = {'input': {}, 'other': {}, 'output': {'outTHIST': ['GLOBAL', 'ATHEXREGTUTORIAL'], 'alloutputs': ['histo.root', 'AnalysisSkeleton.root']}} ,
    option_file = [ File (
       name = '####JOBOPTIONS####' ,
       subdir = '.'
       ) , ] ,
