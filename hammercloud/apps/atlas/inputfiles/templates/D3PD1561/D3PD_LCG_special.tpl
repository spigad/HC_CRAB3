...
Job (
 ...
 application = Athena (
    ...
    atlas_run_dir = 'PhysicsAnalysis/D3PDMaker/D3PDMakerConfig/run/' ,
    stats = {} ,
    ...
    trf_parameter = {} ,
    recex_type = '' ,
    atlas_run_config = {'input': {}, 'other': {}, 'output': {'outAANT': [('AANT1', 'AANT1')], 'alloutputs': ['physics.root']}} ,
    atlas_environment = [] ,
    atlas_production = '' ,
    atlas_release = '15.6.1' ,
    atlas_dbrelease = '' ,
    options = '' ,
 ...
 backend = LCG (
    middleware = 'GLITE' ,
    CE = 'ce1.bfg.uni-freiburg.de:2119/jobmanager-lcgpbs-medium' ,
    perusable = False ,
    jobtype = 'Normal' ,
