Job (
 ...
 application = Athena (
    ...
    trf_parameter = {} ,
    recex_type = '' ,
    atlas_run_config = {'input': {}, 'other': {}, 'output': {'outAANT': [('StreamNTUP_EGAMMAAANTStream', 'StreamNTUP_EGAMMA', 'egamma.root')], 'outTHIST': ['GLOBAL', 'StreamNTUP_EGAMMAD3PDTrigDec'], 'alloutputs': ['egamma.root', 'histo.root', 'egamma.root']}} ,
    atlas_environment = [] ,
    atlas_production = '' ,
